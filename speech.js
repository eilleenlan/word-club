...
(() => {
  ...
  const grade3Recordings = [["next to", "in front of", "between", "behind", "across from", "bookstore", "park", "bakery", "supermarket", "post office", "restaurant", "movie theater", "convenience store"], ["doctor", "work", "hospital", "police officer", "care", "clerk", "cashier", "waiter", "waitress", "fire fighter", "fire station", "police station", "nurse", "teacher"], ["address", "phone", "number", "floor", "alley", "lane", "road", "district", "city", "street", "country", "north", "south", "east", "west"], ["meet", "swimming pool", "swim", "field", "court", "playground", "feed", "picnic", "tomorrow", "walk", "fly", "study", "every day", "thing", "all"]];
  grade3Recordings.forEach((words, i) => words.forEach(word => { recordings[word] = `audio/grade3/unit${i + 1}/${word.replace(/ /g, "-")}.mp3`; }));
  const grade2Recordings = [["finger", "thumb", "body", "foot", "feet", "toe", "leg", "back", "arm", "hand", "have", "has"], ["eye", "ear", "hair", "mouth", "nose", "big", "little", "short", "long", "now"], ["coat", "shirt", "pants", "shorts", "skirt", "socks", "shoes", "dress", "sweater", "glasses"], ["tired", "happy", "sad", "bored", "angry", "crazy", "hungry", "thirsty", "sick", "scared"]];
